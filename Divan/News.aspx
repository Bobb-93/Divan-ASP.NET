<%@ Page Title="News" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="News.aspx.cs" Inherits="Divan.News" %>
    ...
    <main>
        ...
        <article>
            <header>
                ...
                <a href="#"><p class="top-paragraph">A series of small objects<br> designed by Anna Kraitz for<br> Divan.</p></a>
            </header>
